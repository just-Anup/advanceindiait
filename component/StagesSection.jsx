      ...
      >
        ...
        <div className="relative flex h-screen items-center justify-start">
          ...
          <motion.div
            ...
            "
          >
            <p className="text-sm font-medium text-[#D5D8E3]">
              Trusted by Students
            </p>

            <h3 className="mt-1 text-6xl font-black text-[#FBF9F4]">
              10K+
            </h3>

            <div className="mt-2 flex items-center gap-2 text-sm text-[#C9A24B]">
              <FiCheckCircle />
              Growing Every Day
            </div>
          </motion.div>
